...
import './FilterProducts.css'; // Import your CSS file
    ...
    >
      ...
      {categories.map((category, index) => (
        <option
          key={category}
          value={category}
          className="font-serif font-semibold text-white bg-[#df8ef3] border-y-4 border-[#8b2fa2] py-2 px-3 my-1"
      ...
      >
        <MdOutlineFilterAlt className="mr-0" />
      </button>
      <button
        onClick={resetFilter}
