  ...
  return (
    <div className={show ? "block" : "hidden"}>
      <div className="h-screen w-full bg-[#e382fb] bg-opacity-50 dark:bg-opacity-50 dark:bg-gray-800 fixed top-0 left-0 flex items-center justify-center z-50">
        {/* Modal Background */}
        <div className="min-h-fit w-auto md:w-1/2 bg-gradient-to-tl from-[#ebacfb] to-[#f9fbc6] dark:from-[#68217A] dark:to-[#8b2fa2] rounded-3xl shadow-2xl transform transition duration-500 scale-95 hover:scale-100">
          {/* Modal Container */}
          <div className="flex flex-col p-10 rounded-3xl bg-gradient-to-tl from-[#f0f656] to-[#e382fb] dark:bg-gray-900 text-textColor dark:text-white">
            {/* Modal Header */}
            ...
            <div className="w-full flex flex-col items-center">
              ...
              <p className="font-extrabold font-sans text-2xl text-center">Hurry up....Discount</p>
            </div>
          </div>
        </div>
      </div>
