...
async function PopularBrand() {
  ...
  return (
    <div className="mt-5 py-14 px-8 max-w-screen-xl mx-auto bg-gradient-to-tl from-[#ebacfb] to-[#f9fbc6] rounded-3xl border-x-2 border-[#84a123] dark:bg-gradient-to-tl dark:from-[#979595] dark:to-[#000000]">
